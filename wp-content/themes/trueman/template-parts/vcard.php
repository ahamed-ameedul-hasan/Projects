...
<div class="<?php if ( $vcard_name ) : ?>trm-main-card-frame <?php else : ?> trm-main-card-frame trm-sidebar--default<?php endif; ?>trm-sidebar">
  ...
  <div class="trm-main-card" data-scroll data-scroll-repeat data-scroll-sticky data-scroll-target="#content" data-scroll-offset="60">
    ...
    <div class="text-center">
      ...
      <a href="<?php echo esc_url( $button['url'] ); ?>" class="trm-btn"<?php if ( $button['attributes']['download'] ) : ?> download<?php endif; ?><?php if ( $button['attributes']['new_window'] ) : ?> target="_blank"<?php endif; ?>><?php echo esc_html( $button['label'] ); ?> <?php echo wp_kses_post( $button['icon'] ); ?></a>
      <?php endforeach; ?>
    </div>
    <!-- action button end -->
    <?php endif; ?>
