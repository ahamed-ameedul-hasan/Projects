...
function trueman_stylesheets() {
	...
	$menuFont =  get_field( 'menu_font_family', 'option' );
	...
	if ( $menuFont ) {
		wp_enqueue_style( 'trueman-paragraph-font', $menuFont['url'] , array(), null );
	}
...
function trueman_scripts() {
	...
	wp_enqueue_script( 'trueman-jquery-cookie', get_template_directory_uri() . '/assets/js/jquery.cookie.js', array('jquery'), '1.0.0', true );
