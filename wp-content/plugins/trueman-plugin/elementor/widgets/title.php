 ...
 * @since 1.0
 */
class Trueman_Title_Widget extends Widget_Base {

	public function get_name() {
		return 'trueman-title';
	}

	public function get_title() {
		return esc_html__( 'Title', 'trueman-plugin' );
	}
...
Plugin::instance()->widgets_manager->register( new Trueman_Title_Widget() );
