...
class Trueman_Portfolio_Widget extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'show_item_desc',
			[
				'label' => esc_html__( 'Always Display Item Details?', 'trueman-plugin' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Yes', 'trueman-plugin' ),
				'label_off' => __( 'No', 'trueman-plugin' ),
				'return_value' => 'yes',
				'default' => 'no',
				'condition' => [
	...
	protected function render() {
		...
		<div class="<?php echo esc_attr( $rowClass ); ?>">
			...
			if ( $settings['show_item_desc'] == 'yes' ) {
				$itemClass .= ' trm-desc-enabled';
			}
